We need the base chrome components to start implementing the editor screen - the top navbar and left sidebar shell. These will be resused and extended in every chapter that follows.
...
- no lint errors
- dialog pattern is ready is used for future use
